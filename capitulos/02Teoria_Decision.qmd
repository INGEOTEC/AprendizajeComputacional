...
El resultado del código anterior se muestra en la @fig-gaussian_3classes, donde 
...
La @fig-gaussian_3classes-error muestra todos los datos generados, en color azul 
...
momento que las nubes de puntos de la clase 1 y 2 se traslapan como se observa en la @fig-gaussian_3classes.
...
La @fig-gaussian_3classes-distribucion muestra el histograma de la estimación del error en el ejemplo
analizado.
