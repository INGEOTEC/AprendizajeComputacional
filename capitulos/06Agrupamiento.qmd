...
Utilizando `perm` se calcula el accuracy (@sec-accuracy) utilizando la siguiente instrucción. Se obtiene un accuracy de `{python} acc_f` que significa que la mayoría de los datos se agrupan en un conjunto que corresponde a la clase del conjunto del iris. 
