...
Cuando se asume que las matrices de covarianza son iguales para todas las clases, se está en la presencia del algoritmo **Analizados Discriminante Lineal**. Este algoritmo está implementado en la clase `LinearDiscriminantAnalysis`.
